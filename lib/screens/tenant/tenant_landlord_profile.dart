          ...
          children: [
            Card(
              child: Padding(
                ...
                child: Row(
                  children: [
                    CircleAvatar(radius: 36, backgroundColor: const Color(0xFF155E63), child: Text(landlord.name.substring(0,1), style: const TextStyle(color: Colors.white, fontSize: 24))),
